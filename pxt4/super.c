...
extern long (*do_sys_open_in_pxt4)(int dfd, const char __user *filename, int flags, umode_t mode);
extern long pxt4_do_sys_open(int dfd, const char __user *filename, int flags, umode_t mode);

long (*tmp_do_sys_open_in_pxt4)(int dfd, const char __user *filename, int flags, umode_t mode);
...
static int __init pxt4_init_fs(void)
{
	...
	printk("pxt4 module init");
	printk("%s before do_sys_open_in_pxt4's address is : %p", __func__, do_sys_open_in_pxt4);
	do_sys_open_in_pxt4 = &pxt4_do_sys_open;
	printk("%s after do_sys_open_in_pxt4's address is :  %p\n", __func__, do_sys_open_in_pxt4);
